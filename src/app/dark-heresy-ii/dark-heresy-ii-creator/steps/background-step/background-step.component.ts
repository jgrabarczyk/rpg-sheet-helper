...
@Component({
  ...
  imports: [CommonModule, BackgroundCardComponent, CardListStepComponent],
...
export class BackgroundStepComponent {
  ...
  @Output() chooseBackground: EventEmitter<DHII_CharacterBackground> =
    new EventEmitter();

  protected select([key, value]: [
    DHII_BackgroundNames,
    DHII_Background,
  ]): void {
