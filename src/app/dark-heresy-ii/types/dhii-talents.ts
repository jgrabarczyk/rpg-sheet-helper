...
against Daemons gain the Proven (3) quality.`,
  ...
  [
    'Daemonologist',
    {
      ...
      tier: 2,
      prerequisites:
        ' Psy rating 3, Willpower 45, Forbidden Lore (Daemonology)',
...
`,
  ...
  [
    'Purity of Hatred',
    {
      ...
      specialisations: [
        'Any group for which the character possesses the Hatred talent',
      ], // this will be funny to
      aptitudes: ['Offence', 'Willpower'],
      description: `
...
`,
  ...
  [
    'Witch Finder',
    {
      ...
      tier: 2,
      prerequisites:
        ' Rank 2 (Trained) in the Forbidden Lore (Psykers) skill, Willpower 45',
      aptitudes: ['Knowledge', 'Perception'],
...
`,
  ...
  [
    'Daemonic Disruption',
    {
      ...
      tier: 3,
      prerequisites:
        ' Bane of the Daemon, Willpower 50, Untouchable elite advance',
...
`,
  ...
  [
    'Flash of Insight',
    {
      ...
      tier: 3,
      prerequisites:
        ' Contact Network, Coordinated Interrogation, Intelligence 40',
