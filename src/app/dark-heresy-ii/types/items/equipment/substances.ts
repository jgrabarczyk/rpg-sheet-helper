...
export const SUBSTANCES: Map<string, GenericItem> = new Map([
  ...
  [
    'De-Tox',
    {
      ...
      notes: 'Clears any chemical effects. User is Stunned for 1d10 minus Toughness bonus rounds.'
    }
  ],
  [
    'Frenzon',
  ...
  [
    'Ration Pack',
    {
      ...
      notes: 'During rest of at least 2 hours or more remove one additional level of Fatigue.'
    }
  ],
  [
    'Recaf',
