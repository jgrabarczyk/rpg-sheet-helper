...
export const WEAPON_MODIFICATIONS: Map<string, WeaponModification> = new Map([
  ...
  [
    'Backpack Ammo Supply',
    {
      ...
      upgrades:
        'Any Bolt, Flame, Las, Melta, Plasma, and Solid Projectile weapon.',
    },
  ],
  [
    'Compact',
  ...
  [
    'Deactivated Safety Features',
    {
      ...
      availability: Availability.RARE,
      description:
        'May Ready another weapon or draw another item as part of the same action.',
      upgrades: 'Any weapon',
    },
  ],
  [
  ...
  [
    'Fire Selector',
    {
      ...
      availability: Availability.RARE,
      description:
        "Swap ammo types without reloading. Can hold 3 different ammo's.",
      upgrades:
        'Any Bolt, Launcher, and Solid Projectile weapon of the Pistol or Basic class.',
    },
  ],
  [
    'Fluid Action',
  ...
  [
    'Forearm Weapon Mounting',
    {
      ...
      upgrades:
        'Any Las, Low-Tech, Solid Projectile, Bolt, or Melta of the Pistol class.',
    },
  ],
  [
    'Melee Attachment',
    {
      ...
      description:
        'The ranged weapon counts as a spear when used in melee combat.',
  ...
  [
    'Motion Predictor',
    {
      ...
      upgrades:
        'Any Ranged weapon (except Low-Tech) Capable of Semi-Auto or Full Auto.',
    },
  ],
  [
    'Omni-Scope',
  ...
  [
    'Pistol Grip',
    {
      ...
      availability: Availability.RARE,
      description:
        'Can be wielded in one hand without -20 penalty. Range is halved.',
      upgrades: 'Any Basic ranged weapon.',
    },
  ],
  [
  ...
  [
    'Quick-Release',
    {
      ...
      availability: Availability.RARE,
      description:
        'The weapon reduced by a Half Action, to a minimum of a Half Action.',
  ...
  [
    'Vox-Operated',
    {
      ...
      upgrades:
        'Any Pistol, Basic, Launcher, or Heavy weapon that is not of the Low-Tech type.',
    },
  ],
]);
