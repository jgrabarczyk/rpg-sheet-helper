...
export const WEAPON_TRAITS: Map<string, WeaponTrait> = new Map([
  [
    'Accurate',
    {
      name: 'Accurate',
  ...
  [
    'Defensive',
    {
      name: 'Defensive',
      description:
        'Grants +15 bonus to Parry and -10 penalty to hit when using this weapon. Add 2 Armour Points On Trunk And Hand in which is wielded',
    },
  ],
  [
    'Felling (X)',
  ...
  [
    'Flexible',
    {
      name: 'Flexible',
      description:
        'This weapon cannot be parried, but can be used to parry attacks.',
    },
  ],
  [
    'Force',
    {
      name: 'Force',
      description: 'Normal weapon unless wielded by a psyker (see CB p. 145).',
    },
  ],
  [
    'Graviton',
    {
      name: 'Graviton',
      description:
        'Weapon inflicts additional damage equal to AP on Hit Location.',
    },
  ],
  [
    'Hallucinogenic (X)',
  ...
  [
    ...
    {
      name: 'Inaccurate',
      description: 'Weapon gains no bonus from Aiming.',
    },
  ],
  [
    'Indirect (X)',
  ...
  [
    ...
    {
      name: 'Lance',
      description: 'Weapon increases its Penetration to (1+DoS)xPen.',
    },
  ],
  [
    'Maximal',
  ...
  [
    ...
    {
      name: 'Razor Sharp',
      description: 'If attack results in 3+ DoS, double weapon Pen.',
    },
  ],
  [
    'Recharge',
    {
      name: 'Recharge',
      description: 'When fired, cannot be fired again in the next round.',
    },
  ],
  [
    'Reliable',
  ...
  [
    'Sanctified',
    {
      name: 'Sanctified',
      description:
        'This weapon deals Holy damage to Daemonic and Warp creatures.',
    },
  ],
  [
    'Scatter',
  ...
  [
    'Smoke (X)',
    {
      name: 'Smoke (X)',
      description:
        'Creates smoke cloud with radius of (X) metres lasting 1d10+10 rounds.',
    },
  ],
  [
    'Snare (X)',
  ...
  [
    'Storm',
    {
      name: 'Storm',
      description:
        'Double number of hits inflicted on target (and ammo expended).',
    },
  ],
  [
    'Tainted',
  ...
  [
    ...
    {
      name: 'Tearing',
      description: 'Roll one extra die for damage, discard the lowest.',
    },
  ],
  [
    'Toxic (X)',
  ...
  [
    ...
    {
      name: 'Unbalanced',
      description: '-10 to Parry, cannot make Lightning Attacks.',
    },
  ],
  [
    'Unreliable',
    {
      name: 'Unreliable',
      description: 'Weapon jams on roll of 91+ even in Semi-/Full-Auto.',
    },
  ],
  [
    'Unwieldy',
    {
      name: 'Unwieldy',
      description: 'Cannot Parry or make Lightning Attacks.',
    },
  ],
  [
    'Vengeful (X)',
    {
      name: 'Vengeful (X)',
      description: 'Inflicts Righteous Fury on damage rolls of X or higher.',
    },
  ],
]);
