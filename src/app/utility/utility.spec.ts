...
describe('Utility Unit tests', () => {
  describe('test assertion', () => {
    describe('function assertAttributeName', () => {
      it('should throw error when "Influence" is passed as argument', () => {
        expect(() => assertAttributeName('Influence')).toThrowError(
          'Influence is Excluded in this scope'
        );
      });
    });
    describe('function assertUnreachable', () => {
      it('Should throw Error when assertion is not exhausted correctly', () => {
        expect(() => {
